        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="font-sans text-text-on-dark text-lg md:text-xl max-w-3xl mb-8 leading-relaxed">
              Ready to transform your financial operations? Our UAE team of expert accountants is here to provide 
              tailored solutions that drive your business forward across all Emirates and free zones.
            </p>
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <p className="font-sans text-charcoal-600 text-lg mb-8 leading-relaxed">
                ...
                We're committed to providing exceptional service and expert guidance across all Emirates.
              </p>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <select className="font-sans w-full px-4 py-3 rounded-lg border border-charcoal-300 focus:outline-none focus:border-gold-primary focus:ring-2 focus:ring-gold-primary/20 transition-all bg-white">
                    ...
                    <option value="bookkeeping">Bookkeeping & Management Accounts (IFRS)</option>
                    <option value="vat">VAT Registration & Filing</option>
                    <option value="corporate-tax">UAE Corporate Tax (9% Regime)</option>
                    <option value="payroll">Payroll & WPS Compliance</option>
                    <option value="free-zone">Free Zone Accounting</option>
                    <option value="financial-reporting">Financial Reporting & Forecasting</option>
                    <option value="cfo-advisory">CFO Advisory (Part-Time)</option>
                    <option value="esr-ubo">ESR Reporting & UBO Register</option>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="font-sans text-text-on-dark text-lg mb-8 leading-relaxed">
              Book a free consultation with our expert team and discover how we can help your business thrive across all Emirates.
            </p>
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
